...
void show_device_info_0(u8 num)
{
	...
	{
		case BOOT_PANEL: strcpy((char*)str,"BP");break;
		case BOOT_CONTROLLER: strcpy((char*)str,"BC");break;
		case MAIN_PANEL: strcpy((char*)str,"MP");break;
		case MAIN_CONTROLLER: strcpy((char*)str,"MC");break;
	}				

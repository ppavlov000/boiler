...
u8 FAN_Speed=0;
s16 Temperature=0;
#define FAN_N_1 		Obj[1]
#define FAN_N_2 		Obj[2]
#define FAN_N_3 		Obj[3]

#define FAN_SPEED 		Obj[5]
//-----------------------------------------------------------------------------------
void Choose_FAN_1()
{
	FAN_Number=1;	
...
void Choose_SPEED()
{
	...
	{
		if(FAN_SPEED.pict_num!=68+FAN_Speed)
		{
			FAN_SPEED.pict_num=68+FAN_Speed;
...
{
	u8 i;
//	Obj[0]=_Temperature_Exit;	
	Obj[0]=_Temperature_Main;	
	Obj[1]=_Temperature_Fan_1;	
	Obj[2]=_Temperature_Fan_2;	
	Obj[3]=_Temperature_Fan_3;		

	Obj[4]=_Temperature_Auto;	

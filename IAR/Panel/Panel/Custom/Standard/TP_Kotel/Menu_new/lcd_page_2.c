...
*/
extern __farflash u8	eng_kot_errors_str[][25];
...
//				BUZZ_Time=50;
			...
			switch(step)
			{
				case 0:
					step++;
					M_Get_Controller_Register(1,&errors,sizeof(TErrors));
					M_SCH_Time=100;
				break;				
				case 1:
					step++;
				...
				case 50:
					...
					M_Set_Controller_Register(1,&errors,sizeof(TErrors));
					M_SCH_Time=50;	
				break;
				case 51:
					step=0;					
					tmp=1;
					upc_Set_Controller_In_Params(1,3,(u8*)&tmp,1);
					M_SCH_Time=100;	
				break;
				default:
				step=0;

	...
	{		
		...
		{			
			...
			{				
				...
				case 5:
					// Temperature PID[0]
					M_Set_Controller_Register(0,&pid[0].t0,2);					
					step++;					
					M_SCH_Time=10;	
				break;
				case 6:
					// Temperature PID[1]
					M_Set_Controller_Register(0,&pid[1].t0,2);					
					step++;					
					M_SCH_Time=10;	
				break;
				case 7:
				...
				case 60:
					// Only Fan mode
					M_Set_Controller_Register(0,&fan[0].Fan_Mode,1);					
//					step=0;		
					step+=10;										
					M_SCH_Time=10;	
				break;
				case 61:
					// Fan mode + Fan speed
					M_Set_Controller_Register(0,&fan[0].Fan_Mode,2);					
//					step=0;		
					step+=10;
					M_SCH_Time=10;	
				break;
				case 62:
					// Day/Night
					M_Set_Controller_Register(0,&fan[0].Day_Night,1);					
//					step=0;					
					step+=10;															
					M_SCH_Time=10;	
				break;
				case 63:
					// Temperature
					M_Set_Controller_Register(0,&fan[0].T,2);					
//					step=0;		
					step+=10;															
					M_SCH_Time=10;	
				break;
				case 64:
					// Season
					M_Set_Controller_Register(0,&MenuRegs.Season.season,1);					
//					step=0;			
					step+=10;															
					M_SCH_Time=10;	
				break;
				case 65:
					...
					M_Set_Controller_Register(0,&errors,sizeof(errors));					
					//step=0;					
					step+=10;
					M_SCH_Time=10;	
				break;

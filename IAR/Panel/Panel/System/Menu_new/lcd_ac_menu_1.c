...
void scr3_routine()
{
	...
	u16 tmp0;
	//**************************************************		
	if(m.fan.Temperature_1<3)
	{
		m.fan.Temperature_1=3;
		upc.data_status|=b_fancoil_new;
	}
	if(m.fan.Temperature_1>19)
	{
		m.fan.Temperature_1=19;	
		upc.data_status|=b_fancoil_new;
	}
	
	temp=175+m.fan.Temperature_1*5;
...
{
//	s16 Diff;
	m.fan.Temperature_1+=1;
	if(m.fan.Temperature_1>19)m.fan.Temperature_1=19;
	upc.data_status|=b_fancoil_new;
}
//-----------------------------------------------------------------------------------
void Mod_Temperature_Down()
...
//	s16 Diff;
	m.fan.Temperature_1-=1;
	if(m.fan.Temperature_1<3)m.fan.Temperature_1=3;	
	upc.data_status|=b_fancoil_new;
}
//-----------------------------------------------------------------------------------
void handle_fan_buttons_0()

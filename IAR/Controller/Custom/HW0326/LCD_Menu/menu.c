...
void rp_custom_timer_time();
void lcd_custom_timer_choose_time();
void lcd_custom_timer_edit_time();
...
//  "Text",  Access LVL, function, up, down, previous, next
	...
	// PID 0
//	"PID", "ПИД",												0, 0, rp_pid_0,  0, 1,-3, 27,	//3	
	"PID", "ПИД",												0, 0, rp_pid_0,  0, 1,-3, 54,	//3	
	...
	"Diff D=","Дифф D=",										1, 0, rp_PID_D,    -9,  1, -2, 2,		//11
		"Diff D=","Дифф D=",									2, 0, ed_PID_D,    -1,  0,  0, 0,		//11
	"Low  S=","Медл S=",										1, 0, rp_PID_SLOW, -11,  1, -2, 2,		//12
		"Low  S=","Медл S=",									2, 0, ed_PID_SLOW, -1,  0,  0, 0,		//12	
	"Fast S=","Быст S=",										1, 0, rp_PID_FAST, -13,  1, -2, 2,	  	//13		
		"Fast S=","Быст S=",									2, 0, ed_PID_FAST, -1,  0,  0, 0,	  	//13			
	"Summ P=","Сумм P=",										1, 0, rp_PID_SSUM, -15,  1, -2, 2,		//8	
		"Summ P=","Сумм P=",									2, 0, ed_PID_SSUM, -1,  0,  0, 0,		//8		
	"Zero B=","Ноль B=",										1, 0, rp_PID_ZEROB,-17, 1, -2, 2,		//12
		"Zero B=","Ноль B=",									2, 0, ed_PID_ZEROB,-1,  0,  0, 0,		//12	
	"Low  B=","Слаб B=",										1, 0, rp_PID_LOWB, -19, 1, -2, 2,	  	//13			
		"Low  B=","Слаб B=",									2, 0, ed_PID_LOWB, -1,  0,  0, 0,	  	//13				
	"Max  P=","Макс P=",										1, 0, rp_PID_PMAX, -21, 1, -2, 2,		//7
		"Max  P=","Макс P=",									2, 0, ed_PID_PMAX, -1,  0,  0, 0,		//7	
	"Min  P=","Мин  P=",										1, 0, rp_PID_PMIN, -23, 1, -2, 2,		//8
		"Min  P=","Мин  P=",									2, 0, ed_PID_PMIN, -1,  0,  0, 0,		//8	
	"Valve T=","Клапан Т=",										1, 0, rp_PID_T3, -25, 1, -2, 0,		//8
		"Valve T=","Клапан Т=",									2, 0, ed_PID_T3, -1,  0,  0, 0,		//8		

	// PID 1
	"PID", "ПИД",												0, 0, rp_pid_1,  	0,  1,-27, 27,		//3	
	"Enable=","Вкл   =",										1, 0, rp_PID_MODE, -1,  0,  0, 1,		//4
	"Tmp T0=","Темп T=",										1, 0, rp_PID_T,    -2,  1, -1, 2,		//5
		"Tmp T0=","Темп T=",									1, 0, ed_PID_T,    -1,  0,  0, 0,		//5	
	"Curr P=","Тек  P=",										1, 0, rp_PID_POWER,-4,  0, -2, 1,		//6
	...
	// Mistakes
	"Brakedowns", "Аварии",										0, 0, rp_text,  0, 1, -54, 2,	//14
	...
	"AUTO/MANUAL", "АВТО/РУЧНОЙ",								1, 0, rp_text, -5, 1,-2, 2,	//14		
		"", "",			   										2, 0, lcd_menu_choose_prmode,   -1, 0, 0, 0,	//14			
	"Parameters", "Параметры",									1, 0, rp_text, -7, 1,-2, 3,	//14		
		"", "",			   										2, 0, lcd_menu_choose_parameters,   -1, 1, 0, 0,	//14			
		"", "",			   										2, 0, lcd_menu_edit_parameters,   -1, 0, 0, 0,	//14			

	// Custom PID timer
	"PID Timer", "ПИД Таймер",									1, 0, rp_custom_pid_time,  -10, 1, -3, 3,	//14	
	"", "",														1, 1, lcd_custom_pid_choose_time, -1, 1, 0, 0,	//14	
	"", "",														2, 1, lcd_custom_pid_edit_time,   -1, 0, 0, 0,	//14		

	// Custom DI4 Timer
	"DI4 Timer", "DI4 Таймер",									1, 0, rp_custom_timer_time,  -13, 1, -3, 3,	//14	
	"", "",														1, 1, lcd_custom_timer_choose_time, -1, 1, 0, 0,	//14	
	"", "",														2, 1, lcd_custom_timer_edit_time,   -1, 0, 0, 0,	//14		

	"Digital IN", "Цифровой   Вход",							1, 0, rp_text, -16, 1,-3, 2,	//14		
		"DI", "DI",			   									2, 0, rp_DI,   -1, 0, 0, 0,	//14			
	"Digital OUT","Цифровой   Вых",								1, 0, rp_text, -18, 1,-2, 2,	//14			
		"DO", "DO",			   									2, 0, rp_DO,   -1, 0, 0, 0,	//14				
	"Analog  IN", "Аналоговый Вход",							1, 0, rp_text, -20, 1,-2, 2,	//14		
		"AI", "AI",			   									2, 0, rp_AI,   -1, 0, 0, 0,	//14				
	"Analog  OUT","Аналоговый Вых",								1, 0, rp_text,-22, 1,-2, 2,	//14				
		"AO", "AO",			   									2, 0, rp_AO,   -1, 0, 0, 0,	//14	
		
	"Password","Пароль",										0, 0, rp_text,    -18, 1,-2, 0,	//14
